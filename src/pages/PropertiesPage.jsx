            ...
            {(isFilterOpen || window.innerWidth >= 1024) && (
              <>
                ...
                <motion.div
                  ...
                  className="fixed inset-y-0 left-0 z-50 bg-white shadow-xl w-72 lg:relative lg:sticky lg:top-20 lg:h-fit lg:w-64 lg:shadow-none lg:border lg:border-gray-200 lg:rounded-lg"
                >
                  {/* Mobile Header */}
