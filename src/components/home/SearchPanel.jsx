    ...
    >
      <form onSubmit={handleSearch} className="grid grid-cols-1 gap-4 md:grid-cols-4">
        ...
        <select
          ...
          className="w-full px-4 py-3 text-white border rounded-lg appearance-none border-white/30 bg-white/20 backdrop-blur-sm focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent"
          style={{
